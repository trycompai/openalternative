...
const getMetadata = (category: CategoryOne): Metadata => {
  ...
  return {
    title: `Free & Open Source ${name}`,
    description: `A collection of the ${category._count.tools} best free & open source ${name}. Find inspiration, screenshots and detailed reviews for every listing.`,
  }
}
